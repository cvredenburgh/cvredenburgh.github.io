...
export default function ProjectArticle() {
  ...
  const handleShare = async (method: 'native' | 'twitter' | 'linkedin' | 'email') => {
    if (!project) return;
    ...
    if (method === 'native' && typeof navigator !== 'undefined' && 'share' in navigator && navigator.share) {
      try {
        ...
        console.log('Native share cancelled or failed, falling back to social links');
      }
    }
